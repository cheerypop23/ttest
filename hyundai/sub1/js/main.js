...
async function init() {
  ...
  const gltf = await gltfLoader.loadAsync('./src/hyundai_kona/scene.gltf');
  ...
  cars.scale.set(0.011,0.011,0.011)
  cars.rotation.y = 100;
  cars.rotation.x = 50.25;
  cars.position.set(-2,-1,0.5);
  scene.add(cars);
  ...
  spotLight.position.set( 10, 10, 19 );
